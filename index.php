                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-5 text-right">
                                    <label for="">What Solution are you looking for ?</label>
                                </div>
                                <div class="col-md-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select name="currency" class="form-control" style="margin-bottom: 0px !important; height: 46px;">
...
<div id="banner" class="home bannerSlider">
    <div class="slider">
        <div class="land-delta">
            <div class="del del-abt">
                <h1>
                <span class="svg">We pride ourselves</span>
                <br>
                <span class="svg">on delivering<large> above</large> our</span> 
                <br> <span class="svg">  <large>customer's expectations.</large></span> </h1>
                <br>
                <br>
                <br>
                <br>
    ...
    <div class="textSlider" data-0=" opacity: 1; top:26%;" data-300="opacity:0; top:15%;">
        <div class="textGroup">
            ...
            <span>/</span>
            <div class="rotater2">
                <h1 class="second">DEVELOP</h1>
                <h1>PASSION</h1>
                <h1>EXPRESS</h1>
            </div>
            <span>/</span>
            <div class="rotater3">
                <h1 class="third">IMPROVE</h1>
                <h1>SHARE</h1>
                <h1>QUALITY</h1>
            </div>
        </div>
...
<div class="page_content">
    ...
    <!-- our story-->
    <div class="aboutus" style="background: rgb(249, 249, 249) none repeat scroll 0% 0%;" id="ourstory">
        <div class="container-fluid">
            <div class="main-heading">
                <div class="col-md-5 text-center namstay-img">
                ...
                <div class="col-md-7 text-center mantra-text">
                    ...
                    <br><br>
                   Life is too short for doing subpar, mediocre work. We make the most of this adage at Walkwel, with pride, hardwork, and more cups of chai.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="">
                    <div class="grid">
                        <figure class="effect-goliath">
                            <img src="img/java.jpg" alt="img18"/>
                            <figcaption>
                                <h2> <span></span></h2>
                                <p>Java</p>
                            </figcaption>           
                        ...
                        <figure class="effect-goliath">
                            <img src="img/html5.jpg" alt="img22"/>
                            <figcaption>
                                <h2><span></span></h2>
                                <p>HTML 5</p>
                            </figcaption>           
                        ...
                        <figure class="effect-goliath">
                            <img src="img/node.jpg" alt="img18"/>
                            <figcaption>
                                <h2> <span></span></h2>
                                <p>Node.Js</p>
                            </figcaption>           
                        ...
                        <figure class="effect-goliath">
                            <img src="img/android.jpg" alt="img22"/>
                            <figcaption>
                                <h2><span></span></h2>
                                <p>Android</p>
                            </figcaption>           
                        ...
                        <figure class="effect-goliath">
                            <img src="img/mysql.jpg" alt="img22"/>
                            <figcaption>
                                <h2><span></span></h2>
                                <p>MySQL</p>
                            </figcaption>           
                    ...
                    <div class="grid">
                        ...
                        <figure class="effect-goliath">
                            <img src="img/windows.jpg" alt="img18"/>
                            <figcaption>
                                <h2> <span></span></h2>
                                <p>Windows</p>
                            </figcaption>           
    ...
    <div class="cube">
    <div class="location">
        <div class="office ban">
            <h4 class="located">Bengaluru Office</h4>
            <p> <strong>Address:</strong> Plot 50, 9th Main,   <br>
            BTM 1st Stage, Bengaluru, (KA).</p>
            <p> <strong>Call Us:</strong> +91-73537-00123</p>
            <p> <strong>Email:</strong> sales@walkwel.in</p>
        </div>
        <div class="map">
            <a href="https://www.google.co.in/maps/place/50A,+9th+D+Main+Rd,+KEB+Colony,+Stage+1,+BTM+Layout,+Bengaluru,+Karnataka+560029/@12.9169066,77.6057167,19z/data=!4m2!3m1!1s0x3bae15018a46833d:0x612d1d830673df04" target="_blank"><img src="img/banloc.jpg" alt="" class="img-responsive"></a>
        </div>
    </div> 
    <div class="location">
        
        <div class="office jal">
            <h4 class="located">Jalandhar Office</h4>
            <p> <strong>Address:</strong> 4th Floor, PKF Building, <br>
      Namdev Chowk, Jalandhar (PB).</p>
            <p> <strong>Call Us:</strong> +91 (181) 5041414</p>
            <p> <strong>Email:</strong> info@walkwel.in</p>
        </div>
        <div class="map">
            <a href="https://www.google.co.in/maps/place/Walkwel+Technology+Pvt.+Ltd./@31.3211934,75.5817813,17.25z/data=!4m2!3m1!1s0x391a5bc9b0000025:0x7b5c8237ff0eca89" target="_blank"><img src="img/jalloc.jpg" alt="" class="img-responsive"></a>
        </div>
    </div>
    <div class="location">
       
        <div class="office chd">
            <h4 class="located">Chandigarh Office</h4>
            <p> <strong>Address:</strong>  Quark City Attrium <br>
      Phase 8 Mohali (PB).</p>
           
        </div>
         <div class="map">
            <a href="https://www.google.co.in/maps/search/Quark+City+Attrium+Phase+8+Mohali/@30.7058908,76.6894611,17z" target="_blank"><img src="img/chdloc.jpg" alt="" class="img-responsive"></a>
        </div>
    </div>
</div>
<div class="mobile">
    ...
    <div class="location2">
        <div class="office ban">
            ...
            <p> <strong>Call Us:</strong> +91-73537-00123</p>
            <p> <strong>Email:</strong> sales@walkwel.in</p>
            <a href="https://www.google.co.in/maps/place/50A,+9th+D+Main+Rd,+KEB+Colony,+Stage+1,+BTM+Layout,+Bengaluru,+Karnataka+560029/@12.9169066,77.6057167,19z/data=!4m2!3m1!1s0x3bae15018a46833d:0x612d1d830673df04" target="_blank">Get directions</a>
        </div>
    </div> 
    <div class="location2">
      ...
      Namdev Chowk, Jalandhar (PB).</p>
            <p> <strong>Call Us:</strong> +91 (181) 5041414</p>
            <p> <strong>Email:</strong> info@walkwel.in</p>
            <a href="https://www.google.co.in/maps/place/Walkwel+Technology+Pvt.+Ltd./@31.3211934,75.5817813,17.25z/data=!4m2!3m1!1s0x391a5bc9b0000025:0x7b5c8237ff0eca89" target="_blank">get directions</a>
        </div>
    </div>
    <div class="location2">
        ...
        <div class="office chd">
           <h4 class="located">Chandigarh Office</h4>
            <p> <strong>Address:</strong>  Quark City Attrium <br>
      Phase 8 Mohali (PB).</p>
            <a href="https://www.google.co.in/maps/search/Quark+City+Attrium+Phase+8+Mohali/@30.7058908,76.6894611,17z" target="_blank">get directions</a>
        </div>
    </div>
</div> 
            ...
            <div class="footer-sections">            
                <div class="col-md-3 col-sm-4">
                    <div class="footer-widget">
                        ...
                        <!-- List Items -->
                            ...
                            <li> <a href="portfolio.html">Our Portfolio</a> <i class="fa fa-plus-circle" id="ssl"></i>
                                <ul class="sublist sublist-height">
                                    <li><a href="web-development.html">Web Development</a></li>
                                    <li><a href="erp-solutions.html">ERP Solutions</a></li>
                                    <li><a href="e-commerce-solutions.html">e-Commerce</a></li>
                                </ul>
                ...
                <div class="col-md-3 col-sm-4" id="solutions">
                    <div class="footer-widget">
                        ...
                        <ul >
                        <!-- List Items -->
                            <li> <a href="solutions.html">Website Designing</a> </li>
                            <li> <a href="solutions.html">Web Development</a> </li>
                            <li> <a href="solutions.html">Mobile App</a> </li>
                            <li> <a href="solutions.html">SEO</a> </li>
                            <li> <a href="solutions.html">Custom Software</a> </li>
                            <li> <a href="solutions.html">Quality Assurance</a> </li>
                            <li> <a href="solutions.html">Integration</a> </li>                    
                            <li> <a href="solutions.html">E-commerce</a> </li>                   
                            <li> <a href="solutions.html">Outsourcing</a> </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="footer-widget">
                        <div class="widget-title"> 
                          <!-- Title -->
                          <h3 class="title">Walkwel Technology Pvt. Ltd.</h3>
                        </div>
                    <!-- Count -->
                        <div class="iso-cert">
                    ...
                    <!-- Social Links -->
                        <div class="social-icon gray-bg icons-circle i-3x"> 
                          <span class="social-links"><a target="blank" href="https://www.facebook.com/walkwel"> <i class="fa fa-facebook"></i> </a> </span>
                          <span class="social-links"><a target="blank" href="https://in.linkedin.com/company/walkwel-technology"> <i class="fa fa-linkedin"></i> </a> </span>
                          <span class="social-links"><a target="blank" href="https://twitter.com/walkwel"> <i class="fa fa-twitter"></i> </a></span>
                          <span class="social-links"><a target="blank" href="https://plus.google.com/+WalkwelIn/"> <i class="fa fa-google-plus"></i></a></span>
...
$(document).scroll(function() {
    ...
    if (scrolTop >= 2257) {
        $('.targetPoints').addClass('animate');
        $('.radarStick').addClass('animate');
        setTimeout(function(){
            $('.targetPoints').removeClass('animate')

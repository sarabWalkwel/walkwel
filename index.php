...
<style>
    ...
    .processCircle{
        ...
        height: 600px;
        border-radius: 50%;
        background: #4a3d2a; /* Old browsers */
/* IE9 SVG, needs conditional override of 'filter' to 'none' */
background: url(data:image/svg+xml;base64,);
background: -moz-radial-gradient(center, ellipse cover,  #4a3d2a 0%, #362d1c 100%); /* FF3.6+ */
background: -webkit-gradient(radial, center center, 0px, center center, 100%, color-stop(0%,#4a3d2a), color-stop(100%,#362d1c)); /* Chrome,Safari4+ */
background: -webkit-radial-gradient(center, ellipse cover,  #4a3d2a 0%,#362d1c 100%); /* Chrome10+,Safari5.1+ */
background: -o-radial-gradient(center, ellipse cover,  #4a3d2a 0%,#362d1c 100%); /* Opera 12+ */
background: -ms-radial-gradient(center, ellipse cover,  #4a3d2a 0%,#362d1c 100%); /* IE10+ */
background: radial-gradient(ellipse at center,  #4a3d2a 0%,#362d1c 100%); /* W3C */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#4a3d2a', endColorstr='#362d1c',GradientType=1 ); /* IE6-8 fallback on horizontal gradient */
    ...
    .targetPoints.animate{
        animation: radarPoints 1s ease ;

        opacity: 0;
    }
    .radarStick.animate{
        animation: radarStick 7s linear;
    }
    @keyframes bars {
        0% {
            width: 150px;
